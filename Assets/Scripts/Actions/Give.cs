...
public class Give : Action
{
    public override void RespondToInput(GameController controller, string noun)
    {
        ...
        if (GiveToItem(controller, controller.player.currentLocation.itemList, noun))
            return;
    ...
    private bool GiveToItem(GameController controller, List<Item> itemList, string noun)
    {
